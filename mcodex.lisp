...
(defparameter *ssh-host* "web.metacircular.net"
  "Default remote host and path for rsync deployment.")

(defun remote-directory (host destination)
...
(defun deploy-site (&key (destination *ssh-host*)
